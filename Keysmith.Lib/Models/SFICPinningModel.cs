...
public class SFICPinningModel : StandardPinningModel
{
    #region Properties
    public ObservableCollection<IKeyModel> ControlKeys { get; init; } = new();
    public ObservableCollection<IKeyModel> OperatingKeys { get; init; } = new();
    public override ObservableCollection<IKeyModel> Keys 
    {
        get { return CombineControlAndOperatingKeys(ControlKeys, OperatingKeys); }
        init { throw new NotImplementedException("Attempt to directly set SFICPinningModel.Keys"); }
    }
    #endregion
    #region Constructors
    public SFICPinningModel():base() { }
    #endregion
    ...
    public static ObservableCollection<IKeyModel> CombineControlAndOperatingKeys
        (ObservableCollection<IKeyModel> inputControlKeys, ObservableCollection<IKeyModel> inputOperatingKeys)
    {
        ObservableCollection<IKeyModel> output = new();

        foreach(IKeyModel currentKey in inputControlKeys)
