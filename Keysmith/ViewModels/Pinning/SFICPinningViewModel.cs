...
{
    class SFICPinningViewModel : ListViewModel<KeyModel>
    {
        #region Private Members
        private SFICPinningModel _pinning = new SFICPinningModel();
        ...
        { Pinning = new SFICPinningModel(SelectedKeys); }
