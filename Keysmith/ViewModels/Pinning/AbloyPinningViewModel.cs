...
{
    class AbloyPinningViewModel : ListViewModel<KeyModel>
    {
        #region Private Members
        private AbloyPinningModel _pinning = new AbloyPinningModel();
        ...
        public AbloyPinningModel Pinning
        {
            get { return _pinning; }
            set
            {
        ...
        { Pinning = new AbloyPinningModel(SelectedKeys); }
