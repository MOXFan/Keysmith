...
namespace Keysmith.Behaviors
{
	public class EventToCommandBehavior : BehaviorBase<View>
	{
		...
		public static readonly BindableProperty CommandParameterProperty = BindableProperty.Create (nameof(CommandParameterProperty), typeof(object), typeof(EventToCommandBehavior), null);
